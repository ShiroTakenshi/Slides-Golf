...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField] AudioSource golfsound;



    Color imagepowerColor;
    ...
    void Update()
    {
        power.fillAmount = forceFactor;
        if (power.fillAmount < 0.4f)
        {
            imagepowerColor = Color.green;
        }
        else if (power.fillAmount < 0.8f)
        {
            imagepowerColor = Color.yellow;
        }
        else
        {
            imagepowerColor = Color.red;
        }
        ...
        power.color = Color.Lerp(power.color, imagepowerColor, Time.deltaTime * 10);
